...
import com.wekex.apps.homeautomation.RemoteActivity;
...
public class RemoteCatAdapter extends RecyclerView.Adapter<RemoteCatAdapter.ViewHolder> {
    ...
    public RemoteCatAdapter(ArrayList<String> _list, Context context, String _dno, String _cat_type, View.OnClickListener _listener) {
        this._list = _list;
