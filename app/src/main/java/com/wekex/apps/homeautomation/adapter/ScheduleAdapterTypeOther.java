...
public class ScheduleAdapterTypeOther extends RecyclerView.Adapter<ScheduleAdapterTypeOther.ViewHolder> {

    private schedule_model_type_other _schedules;
    private Context context;
    ArrayList<schedule_model_type_other.schedule> _list;

    public SchedulerOperation _obj_other_type;

    public ScheduleAdapterTypeOther(Context contxt, schedule_model_type_other list, SchedulerOperation _obj_other_type) {
        context = contxt;
        _schedules = list;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        schedule_model_type_other.schedule _object = _list.get(position);
        try {
