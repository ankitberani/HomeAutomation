...
public class FillCatRemoteAdapter extends RecyclerView.Adapter<FillCatRemoteAdapter.ViewHolder> {
    ...
    public FillCatRemoteAdapter(ArrayList<String> _list, Context context, String _dno, String _cat_type, View.OnClickListener _listener) {
        this._list = _list;
